  ...
  return (
    ...
    >
      ...
      >
        ...
        <List>
          <Link to="/BossTasks" style={{ textDecoration: "none" }}>
            <ListItem button>
              <ListItemIcon>
                <SupervisedUserCircleIcon />
              </ListItemIcon>
              <ListItemText primary="All duties of the manager" sx={{ color: "black", textDecoration: "none" }} />
            </ListItem>
          </Link>
        </List>
        <List>
          <Link to="/categorys" style={{ textDecoration: "none" }}>
            <ListItem button>
              ...
              <ListItemText primary="categorys" sx={{ color: "black", textDecoration: "none" }} />
            </ListItem>
          </Link>
        </List>
        <Divider />
        <List>
          <Link to="/users" style={{ textDecoration: "none" }}>
            <ListItem button>
              ...
              <ListItemText primary="IT staff" sx={{ color: "black", textDecoration: "none" }} />
            </ListItem>
          </Link>
        </List>
        <List>
          <Link to="/Administration" style={{ textDecoration: "none" }}>
            <ListItem button>
              ...
              <ListItemText primary="Administration" sx={{ color: "black", textDecoration: "none" }} />
            </ListItem>
          </Link>
        </List>
        <List>
          <Link to="/AllusersEmp" style={{ textDecoration: "none" }}>
            <ListItem button>
              <ListItemIcon>
                <PeopleOutlineIcon />
              </ListItemIcon>
              <ListItemText primary="Company employees" sx={{ color: "black", textDecoration: "none" }} />
            </ListItem>
          </Link>
        </List>
        <List>
