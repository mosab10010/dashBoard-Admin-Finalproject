...
function AddUserBossModel(props) {
  const { show, setShow, category } = props
  const { AddBossUserIT, bosstask, categorys } = useContext(TasksContext)
  return (
    <Modal show={show} onHide={() => setShow(false)}>
      <Form onSubmit={AddBossUserIT}>
        <Modal.Header closeButton>
          <Modal.Title>Add Administration</Modal.Title>
        </Modal.Header>
        <Modal.Body>
...
export default AddUserBossModel
